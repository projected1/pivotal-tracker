...
#include "tracker/browser/client_types.h"

#if defined(OS_WIN)
#include "tracker/browser/temp_window_win.h"
#elif defined(OS_LINUX)
#include "tracker/browser/temp_window_x11.h"
#elif defined(OS_MACOSX)
#include "tracker/browser/temp_window_mac.h"
#endif
